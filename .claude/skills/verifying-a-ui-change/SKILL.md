...
Read `.agents/skills/verifying-a-ui-change/SKILL.md` and follow it.

That file is the only copy. This stub exists so Claude Code discovers the
playbook; do not add content here.
